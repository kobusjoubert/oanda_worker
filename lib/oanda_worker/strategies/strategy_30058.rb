module Strategies
  class Strategy30058 < Strategy
    ...
    def step_11
      ...
      take_profit = 10 * PIP_SIZE

      case type
      when 'long'
        take_profit_price = close_at_entry - 13 * PIP_SIZE + take_profit
      when 'short'
        take_profit_price = close_at_entry + 13 * PIP_SIZE - take_profit
      end
    ...
    def step_13
      ...
      take_profit = 17 * PIP_SIZE

      case type
      when 'long'
        stop_loss         = -50 * PIP_SIZE
        take_profit_price = close_at_entry - 26 * PIP_SIZE + take_profit
      when 'short'
        stop_loss         = 50 * PIP_SIZE
        take_profit_price = close_at_entry + 26 * PIP_SIZE - take_profit
      end
