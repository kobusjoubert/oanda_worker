...
#   M30 close    - determine trend.
#   H4  close    - determine trend.
...
#   H4 trend should be in the same direction.
#   M30 trend should be in the same direction.
  ...
  module Steps
    module Strategy48XX2
      ...
      def create_long_order?
        ...
        return false if current_trend_d == 'down'
        return false if current_xo_b == 'o'
        return false if current_xo_c == 'o'
        return false if current_xo_d == 'o'
      ...
      def create_short_order?
        ...
        return false if current_trend_d == 'up'
        return false if current_xo_b == 'x'
        return false if current_xo_c == 'x'
        return false if current_xo_d == 'x'
      ...
      def cancel_long_order?
        ...
        return true if current_trend_d == 'down'
        return true if current_xo_b == 'o'
        return true if current_xo_c == 'o'
        return true if current_xo_d == 'o'
      ...
      def cancel_short_order?
        ...
        return true if current_trend_d == 'up'
        return true if current_xo_b == 'x'
        return true if current_xo_c == 'x'
        return true if current_xo_d == 'x'
      ...
      def indicator_d
        @indicator_d ||= begin
          ...
          indicator['data'].each_with_index do |data, i|
            next unless indicator['data'][i]['attributes']['granularity'] == granularity[3].downcase &&
                        indicator['data'][i]['attributes']['box_size'] == box_size[3] &&
                        indicator['data'][i]['attributes']['reversal_amount'] == reversal_amount[3] &&
                        indicator['data'][i]['attributes']['high_low_close'] == high_low_close[3]
      ...
      def points_d
        @points_d ||= indicator_d['data'].map{ |point| point['attributes'] }
      end
      ...
      def current_trend_d
        @current_trend_d ||= points_d.last['trend']
      end
